    ...
    text.readme = {
      ...
      parts.badges =
        ...
        ''
          ...
          [![License](https://img.shields.io/github/license/${owner}/${name}?style=for-the-badge&logo=creativecommons&color=cba6f7&labelColor=313244&logoColor=cdd6f4)](${repoUrl}/blob/${defaultBranch}/LICENSE)
